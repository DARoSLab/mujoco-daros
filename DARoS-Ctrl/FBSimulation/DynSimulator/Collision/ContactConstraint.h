...
class ContactConstraint {
 ...
 protected:
  ...
  int _CheckJointLim(FBModelState<T> &state);
  ...
  // lists (placeholders) for impacts in cartesian space
  ...
  // lists (placeholders) for impacts in joint space (joint limits)
  std::vector<int> _joint_idx_list;//use this instead of normal array since size not known beforehand
