#ifndef FSM_STATE_TELLO_BALANCESTAND_H
#define FSM_STATE_TELLO_BALANCESTAND_H
 ...
 */
template <typename T>
class Tello_State_BalanceStand : public Tello_State<T> {
 public:
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  Tello_State_BalanceStand(ControlFSMData_Tello<T>* _controlFSMData);
