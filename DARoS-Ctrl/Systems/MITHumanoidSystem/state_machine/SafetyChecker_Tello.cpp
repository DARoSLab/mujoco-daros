 ...
 */
template <typename T>
bool SafetyChecker_Tello<T>::checkSafeOrientation() {
  return true;
}
 ...
 */
template <typename T>
bool SafetyChecker_Tello<T>::checkPDesFoot() {
 ...
 */
template <typename T>
bool SafetyChecker_Tello<T>::checkForceFeedForward() {
  // Assumed safe to start
...
template class SafetyChecker_Tello<float>;
