...
#ifndef PROJECT_PAT_H
#define PROJECT_PAT_H
 ...
 */
template <typename T>
bool buildPatroclus(PatBiped<T> *pat)
{
    ...
    pat->_abadLinkX_offset = -0.047;
    // pat->_abadLinkZ_offset = -0.06127;
    pat->_abadLinkZ_offset = -0.06827;
    ...
    pat->_kneeLinkLength = 0.23;//0.23; //0.205;
    pat->_kneeLinkY_offset = 0.05129 + 0.005;
    ...
    pat->_x_initial.bodyPosition[2] = 0.45;
    ...
    // //Knee Forwards TVR Testing hieght 40
    pat->_x_initial.q[0] = 0.16;
