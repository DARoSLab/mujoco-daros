...
class Kinematics {
    public:
        ...
        Kinematics(int id_in, Eigen::Matrix4d pose_in, Eigen::Matrix3d covariance_in) : 
...
class InEKF {
    ...
    public:
        ...
        void CorrectRI(const Observation& obs);
        void CorrectLI(const Observation& obs);
        ...
        void CorrectKinematicsAndLocalization(const vectorKinematics& measured_kinematics,
            const Eigen::Vector3d p_glb, Eigen::Matrix3d cov);
