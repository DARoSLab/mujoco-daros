...
void matrixFunction_atexit(void)
{
  ...
  matrixFunction_xil_terminate();
  matrixFunction_xil_shutdown();
...
/* End of code generation (_coder_matrixFunction_api.c) */
