...
template <typename T>
JPosCtrlState<T>::JPosCtrlState(ObserverManager<T>* ob_man, PrestoeBipedSystem<T>* sys):
_obs_manager(ob_man),
State<T>(sys){
  _ReadConfig(THIS_COM"/Systems/PrestoeBipedSystem/Configs/jpos_state.yaml");
