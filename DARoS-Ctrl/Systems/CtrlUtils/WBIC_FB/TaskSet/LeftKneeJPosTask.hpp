#ifndef LEFT_KNEE_JPOS_TASK_Cheetah
#define LEFT_KNEE_JPOS_TASK_Cheetah
...
template <typename T>
class LeftKneeJPosTask : public Task<T> {
 public:
  LeftKneeJPosTask(const FloatingBaseModel<T>*);
  virtual ~LeftKneeJPosTask();
